...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.ibb.co/HTVRFSR/20230405-161410.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: process.env.SESSION.trim() || 'Raganork~748d72e33ed5c2c47aa1bbd2fd2e9676:4653786b576b4672644e303d',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us',
    BOT_INFO: process.env.BOT_INFO || 'DARK-SHADOW;DARK-SHADOW;0;https://i.ibb.co/HTVRFSR/20230405-161410.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "DARK-SHADOW",
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || '4d2ce946-ed56-4510-b2de-deeb1d040607',
        APP_NAME: process.env.HEROKU_APP_NAME || 'rrkkk'
    },
